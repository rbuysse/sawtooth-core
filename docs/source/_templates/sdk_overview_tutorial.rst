...
{% else %}
   ...
   `https://github.com/hyperledger/sawtooth-sdk-python/tree/add-sdk/examples/xo_python
   <https://github.com/hyperledger/sawtooth-sdk-python/tree/add-sdk/examples/xo_python>`_.
